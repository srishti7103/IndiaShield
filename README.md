...
Below are interactive visual dashboards generated by the IndiaShield platform:

### 1. Strategic Import Vulnerability Sandbox (SIDS)
![Import Vulnerability Dashboard](images/dashboard_preview_3.png)
*Figure 1: Main SIDS dashboard featuring dynamic actual vs. simulated vulnerability metrics, active sanctions toggle, risk radar supplier fingerprints, and weapons category lock-in heatmap.*

### 2. Strategic Budget Anatomy
![Budget Stacked Area and Donut Charts](images/dashboard_preview_1.png)
*Figure 2: Custom military-grade styling illustrating budget allocations, modernisation trends, and capital utilization.*

### 3. Arms Procurement Flow Pipeline
![Sankey Flow Diagram](images/dashboard_preview_2.png)
*Figure 3: Interactive flow diagram mapping arms procurement volumes (TIV) from global suppliers into India's strategic arsenal.*
